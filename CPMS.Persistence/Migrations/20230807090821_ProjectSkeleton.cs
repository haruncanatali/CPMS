...
{
    /// <inheritdoc />
    public partial class ProjectSkeleton : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ParkPrices", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ParkPriceId = table.Column<long>(type: "bigint", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ParkingServices", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ParkingServices_ParkPrices_ParkPriceId",
                        column: x => x.ParkPriceId,
                        principalTable: "ParkPrices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ParkingServices_ParkingLots_ParkingLotId",
                        column: x => x.ParkingLotId,
                        principalTable: "ParkingLots",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ParkingServices_Vehicles_VehicleId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Price = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    ParkingServiceId = table.Column<long>(type: "bigint", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DeletedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedBy = table.Column<long>(type: "bigint", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ServicePrices_ParkingServices_ParkingServiceId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ParkingServices_ParkingLotId",
                table: "ParkingServices",
                column: "ParkingLotId");

            migrationBuilder.CreateIndex(
                name: "IX_ParkingServices_ParkPriceId",
                table: "ParkingServices",
                column: "ParkPriceId");

            migrationBuilder.CreateIndex(
                name: "IX_ParkingServices_VehicleId",
                table: "ParkingServices",
                column: "VehicleId");

            migrationBuilder.CreateIndex(
                name: "IX_ServicePrices_ParkingServiceId",
                table: "ServicePrices",
